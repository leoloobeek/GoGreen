...
## Using GoGreen
GoGreen is a Golang project (sorry). The [Releases](https://github.com/leoloobeek/GoGreen/releases/) section has executables for Windows, Mac and Linux. To use the source go [here](https://golang.org/doc/install) and get setup with Go. Then you just need the following to download and use the project:
```
